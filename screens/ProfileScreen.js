  ...
  return (
    ...
    <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10,}}>
          <View style={{justifyContent: 'flex-start',}}>
            <Text style={{color:'white', fontSize: 42, fontWeight: 'bold', }}>Juan Perez</Text>
            <Text style={{color:'white', fontSize: 32, justifyContent: 'flex-end',}}>jp@terra.cl</Text>
          </View>
    ...
    <View>
      <View style={{ flexDirection: 'column', justifyContent: 'space-around', padding: 10,}}>
        ...
        <Text style={{color:'black', fontSize: 26,}}>+5695650666</Text>
      </View>
    </View>
